...
def getSQSMsg():
    ...
    url = 'https://sqs.us-east-1.amazonaws.com/691034958748/DiningQueue'
...
def lambda_handler(event, context):
    ...
    es_query = "https://search-dining-domain-es-65mbdknz2a6vy4o54y4ywd6atu.us-east-1.es.amazonaws.com/_search?q={cuisine}".format(
        cuisine=cuisine)
